...
const pageContent = [
  ...
  {
    title: 'Treatment',
    imgSrc: '/img/Cancer Journey/IMG_4563.JPG',
    imgAlt: 'Alex eating with Josh, Dad, and Nicole',
  ...
  {
    title: 'Passing',
    imgSrc: '/img/FamilyPictures/Last Family Portrait.jpg',
...
if (import.meta.server) {
  useSeoMeta({
    ...
    url: 'https://alexwernlimemorial.com/life-story',
  });
}
